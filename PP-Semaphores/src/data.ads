...
package Data is
   ...
   procedure Input_Val_F1 (A,B,C: out Vector; MA,ME: out Matrix);
   procedure Input_Val_F2 (MG,MH,MK: out Matrix);
   procedure Input_Val_F3 (t: out Integer; V,O,P: out Vector; MO,MP,MR: out Matrix);
